...
export const dashboardConfig = {
 ...
 url: "https://majo-exe.onrender.com", // string. Dashboard url, to Disable dashboard, set this to null (Note: when you change it to null the dashboard will not work and commands related to dashboard will not work)
